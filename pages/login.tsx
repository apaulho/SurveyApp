  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (checkData.success) {
        if (checkData.usernameExists || checkData.emailExists) {
          // Show registration error modal
      ...
      alert('Unable to validate user information. Please try again.');
      return;
    }
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Username already in use or email already in database, please try again or use Forgot Password.
              </p>
              <button
